...
def run_sqd(one_body_integrals: np.ndarray,
            ...
            bitstrings_files: list[str] = None,
            save_dir: str = None,
            ) -> SCIResult:
    """
    ...
    if bitstrings_files is not None:
        ...
        # print(f"Loaded {sum(bitstring_counts.values())} bitstrings")
        # print(bitstring_counts)
        # bitstring_counts["10111111011111111000001101011111111111000000"] = 5  # Try to patch
        ...
        if force_fci == True:
            ...
            raise ValueError("No bitstrings found.")
