"""Quick test of get_si_sets_v3 only."""
...
from kcommute.sorted_insertion import get_si_sets_v3
...
print(f"\nTesting get_si_sets_v3 with k=N...")
print(f"Blocks: {blocks}")

try:
    sets = get_si_sets_v3(hamiltonian, blocks, verbosity=0)
    print(f"\n✓ SUCCESS: get_si_sets_v3 completed!")
